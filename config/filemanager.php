...
return [
    ...
    */
    'upload' => [
        'disk' => env('FILEMANAGER_DISK', 'public'),
        'directory' => env('FILEMANAGER_UPLOAD_DIR', ''),
    ...
    */
    'authorization' => [
        ...
        // Use the app policy so permissions are controlled by Role "media.*" access.
        'policy' => \App\Policies\FileSystemItemPolicy::class,
    ],
